...
export const summarizeNote = async (req: any, res: Response) => {
  try {
...
export function extractSummaryAndKeyPoints(message: AIMessage) {
  if (!message.content) return { summary: "", key_points: [] };
